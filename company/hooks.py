...
app_include_js = [
    ...
    "/assets/company/js/invoice.js?v=28",
    "/assets/company/js/purchase.js?v=14",
    ...
    "/assets/company/js/custom_back_button.js?v=8",
    "/assets/company/js/unsaved_changes_guard.js?v=4",
    ...
    "/assets/company/js/global_list_actions.js?v=7",
...
app_include_css = "/assets/company/css/custom.css?v=21"
