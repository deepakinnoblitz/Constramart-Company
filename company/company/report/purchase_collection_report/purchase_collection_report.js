    ...
    filters_config: [
        {
            "setup": function (report) {
                ...
                report.page.fields_dict.purchase.$input.on("change", () => report.set_filter_value("page", 1));
                report.page.fields_dict.vendor_id.$input.on("change", () => report.set_filter_value("page", 1));
